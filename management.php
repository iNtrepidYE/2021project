        ...
        <div class="row sider-row">
            ...
            <div class="col-mg-2">
                <div class="siderMenu-title">
                    <h2>選單Menu</h2>
                    <ul>   
                        <li class='menu_active'><a href="management.php" >網站資訊</a></li>
            ...
            <div class="col-mg-10">
               <div class="sider-container">
                    <h1>網站資訊</h1>
                    <hr>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem placeat dolor excepturi vel non? Magni cumque id, corporis magnam alias vitae quos dolorum harum repudiandae, possimus amet vel dolor odit!</p>
               </div>
            </div>
        </div>
    </div>
